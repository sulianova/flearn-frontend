      ...
      text: [
        ...
        },
        {
          ...
          content: [
            ...
            {
              tag: 'span',
              content: 'помогает компаниям и людям выделиться среди конкурентов, привлекать новую аудиторию, делать текст нагляднее и проще. Его работы используются в бизнесе, маркетинге, рекламе, издательстве и других сферах, где важна визуальная коммуникация.',
            },
          ]
        },
      ]
