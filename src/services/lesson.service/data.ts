...
const lessonData22: ILessonDataDB = {
  ...
  content: [
    ...
    {
      type: 'title',
      title: 'Несколько слоев информации',
    },
    {
      type: 'image',
      imageData: {
...
const lessonData23: ILessonDataDB = {
  id: 'LineShape_RY7PQ3',
  courseId: 'how-to-draw',
  title: 'Объем в линейном рисунке',
  type: 'Theory',
  icon: {
    icon: '/png/3d_emoji_HuggingFace.png',
  },
  ...
  content: [
    {
      ...
      text: [
        {
          tag: 'p',
          content: 'Линия сама по себе плоская, но её можно использовать, чтобы показать форму, глубину и конструкцию предмета. В этом уроке разберём, как сделать так, чтобы предметы в линейном рисунке выглядели объёмными.',
        },
      ]
    },
    {
    ...
    },
    {
      ...
      text: [
        {
          tag: 'p',
          content: 'Чтобы рисунок казался объёмным, полезно использовать лёгкий контур. Даже если внутри предмет прорисован с пониманием формы, толстый внешний контур уплощает его и превращает в вырезанную плоскую фигуру. Лёгкая линия позволяет показать воздушность и сохранить иллюзию пространства.',
        },
      ],
    },
    {
      type: 'title',
      title: 'Толщина предмета',
    },
    {
      type: 'image',
      imageData: {
    ...
    },
    {
      ...
      text: [
        {
          tag: 'p',
          content: 'Всё, что мы рисуем, имеет толщину. Это может быть край подноса, корочка хлеба или усик креветки. Рисуя эти толщинки, художник делает форму более убедительной и понятной. Такие детали помогают зрителю увидеть, что предмет не плоский силуэт, а объемная форма.',
        },
      ]
    },
    {
      type: 'title',
      title: 'Линии изменения поверхности',
    },
    {
      type: 'image',
      imageData: {
    ...
    },
    {
      ...
      text: [
        {
          tag: 'p',
          content: 'Чтобы передать объём, важно показать, где поверхность предмета резко меняет направление. Такие линии объясняют зрителю конструкцию формы. У предметов есть грани, плоскости и изгибы. Для куба это будут линии граней, для шара, цилиндра или конуса — линии, показывающие заворачивание поверхности. Эти места перелома и изгиба помогают сделать плоский рисунок объёмным и читаемым.',
        },
      ],
    },
    {
    ...
    {
      type: 'text',
      text: 'Контроль толщины и темноты линии помогает показать, что ближе к зрителю, а что дальше. Линии на переднем плане можно делать толще и темнее — это усиливает ощущение близости и веса. Более тонкие и светлые линии на заднем плане создают глубину и отдаление. Такой приём помогает выстроить планы и сделать рисунок более объёмным и читаемым.'
    },
        {
      type: 'textImportant',
      text: [
        {
          tag: 'p',
          content: 'Объём в линейном рисунке создаётся не с помощью тона или заливки, а через работу линией.'
        },
        {
          tag: 'p',
          content: 'Лёгкий контур сохраняет ощущение воздуха и не уплощает форму. Прорисовка толщин делает объект массивным и убедительным. Линии, показывающие смену плоскостей, помогают объяснить конструкцию.'
        },
        {
          tag: 'p',
          content: 'Контраст толщины и темноты линий разделяет планы и добавляет глубину. Все эти приёмы вместе помогают передать объём даже в простом рисунке.'
        }
      ]
    }
  ]
  ...
  content: [
    {
      ...
      text: [
        {
          tag: 'p',
          content: 'Необязательно перерисовывать каждую деталь один в один. Фотоаппарат справится с этим лучше. Рисунок — это не копия натуры, а её осмысленная интерпретация. Когда рисунок критикуют за «ошибки» в анатомии или перспективе, часто проблема не в том, что он неточен, а в том, что он не смог впечатлить зрителя. Зрителю скучно, и он ищет к чему придраться — обычно к самому очевидному отличию от фото.',
        }
      ]
    },
    {
    ...
    {
      type: 'title',
      title: 'Смотрите на натуру как на форму',
    },
    {
      type: 'image',
      imageData: {
    ...
    },
    {
      ...
      text: [
        {
          tag: 'p',
          content: 'Чтобы рисунок был похож, важно научиться видеть натуру без ярлыков. Нужно перестать думать «это голова», «это рука», а видеть просто форму, которая соединяется с другой формой. Полезно изучать линии, изгибы, контуры без попытки назвать их. Такой подход помогает избавиться от штампов и рисовать не заученные схемы, а то, что действительно перед глазами.',
        }
      ]
    },
        {
    ...
    },
    {
      ...
      text: [
        {
          tag: 'p',
          content: 'Чтобы передать сложную позу, важно отбросить все привычные представления о том, как она «должна» выглядеть. Нужно смотреть только на то, что есть перед глазами. Даже если форма кажется странной, её стоит честно рисовать. Это помогает уловить характер и правду позы.',
        }
      ]
    },
    {
    ...
    },
    {
      ...
      text: [
        {
          tag: 'p',
          content: 'Чтобы сделать портрет похожим, нужно рассматривать лицо как новую, интересную форму. Обращать внимание на то, что удивляет или запоминается. Рисовать именно эти особенности помогает сохранить индивидуальность и избежать стереотипного «универсального лица».',
        }
      ]
    },
    {
      type: 'title',
      title: 'Сходство в любых предметах',
    },
    {
      type: 'image',
      imageData: {
    ...
    },
    {
      ...
      text: [
        {
          tag: 'p',
          content: 'Принцип тот же для всего: собаки, чайники, мягкие игрушки — неважно. Нужно смотреть на них как на форму с пропорциями, линиями и плоскостями. Увидеть и передать то, что отличает их от других.',
        }
      ]
    },
    {
      ...
      text: [
        {
          ...
          props: { className: 'key-link', target: "_blank", to: 'https://www.litres.ru/book/viktor-melamed/mashineriya-portreta-opyt-zritelya-prepodavatelya-i-hudozhn-51820460/?ysclid=lp0xg2v0qe373268414' },
        },
      ]
    },
  ],
  ...
  content: [
    {
      ...
      text: [
        {
          tag: 'p',
          content: 'В этом уроке будем учиться рисовать похоже линией. Задача — отбирать из натуры только ту информацию, которая действительно нужна для понимания формы и характера предмета.',
        },
      ]
    },
    {
      type: 'title',
      title: 'Опишите, что видите',
    },
    {
      type: 'image',
      imageData: {
    ...
    },
    {
      ...
      text: [
        {
          tag: 'p',
          content: 'Начните с общего анализа. Из каких частей состоит предмет? Что у него больше — ширина или высота? В какую простую фигуру его можно вписать? Например, у кружки есть чаша, ручка и подставка. Всё вместе можно представить как квадрат. А чаша с подставкой вместе вписываются в прямоугольник, у которого высота примерно в полтора раза больше ширины',
        },
      ]
    },
    {
      type: 'title',
      title: 'Проводите горизонтальные и вертикальные прямые',
    },
    {
      type: 'image',
      imageData: {
    ...
    },
    {
      ...
      text: [
        {
          tag: 'p',
          content: 'Мысленно проводите горизонтальные и вертикальные прямые, чтобы сравнить размеры предметов, расстояние между ними. Если сложно, можно потренировать упражнения с отрезками.',
        },
      ]
    },
    {
      type: 'title',
      title: 'Смотрите на контрформу',
    },
    {
      type: 'image',
      imageData: {
    ...
    },
    {
      ...
      text: [
        {
          tag: 'p',
          content: 'Обратите внимание на контрформу — пустое пространство между формами. Иногда нарисовать форму этой «дырки» проще, чем сам контур предмета. Это помогает увидеть и передать пропорции точнее.',
        },
      ]
    },
    {
      type: 'title',
      title: 'Идите от общего к частному',
    },
    {
      type: 'image',
      imageData: {
    ...
    },
    {
      ...
      text: [
        {
          tag: 'p',
          content: 'Рисуйте от общего к частному, чтобы сохранить цельность большой формы. Сначала наметьте чашу и подставку вместе, а потом добавляйте ручку. Такой подход помогает сохранить цельность формы и избежать перекосов.',
        },
                {
          tag: 'p',
          content: 'Сходство добавляет выразительности рисунку. Но важно помнить, что степень сходства выбирает сам художник. Даже искажённые пропорции могут быть выразительными, если это осознанное решение.',
        },
      ]
    },
    {
    ...
    },
    {
      ...
      text: [
        {
          tag: 'p',
          content: 'Детали добавляют выразительности, делают предмет интересным для разглядывания. Сколько и где будет деталей решает автор. Можно равномерно распределить детали по всему предмету, тогда в нем все будет одинаковое. Можно добавить детали только там, куда хотим привлечь внимание, остальное оставить пустым.',
        },
        {
          tag: 'p',
    ...
    },
    {
      ...
      text: [
        {
          tag: 'p',
          content: 'В этом уроке мы научились рисовать похоже, выбирая только то, что действительно важно.',
        },
        {
          tag: 'p',
          content: 'Чтобы правильно передать форму, нужно внимательно смотреть на пропорции и сравнивать части между собой. Контрформа помогает увидеть реальные соотношения и избавиться от шаблонов.',
        },
        {
          tag: 'p',
          content: 'Рисунок лучше начинать с общей формы. Это помогает сохранить цельность и избежать ошибок. Детали добавляют выразительность, но их количество и место выбирает сам автор.',
        },
        {
          tag: 'p',
          content: 'Сходство в рисунке — это не точная копия, а осознанный выбор, что именно вы хотите показать зрителю.',
        },
      ]
    },
  ...
  content: [
    {
      ...
      text: [
        {
          tag: 'p',
          content: 'Задание помогает учиться отбирать из натуры нужную информацию и управлять пропорциями в листе. Потренируемся рисовать чисто и уверенно, без исправлений. ',
        },
      ]
    },
    {
      type: 'title',
      title: 'Шаг 1. Выберите тему',
    },
    {
      type: 'text',
      text: 'Выберите одну тему, с которой будете работать. Например, кошки, собаки, чайники, лягушки. Найдите 30-40 референсов по выбранной теме из своего фотоархива или интернета.',
    },
    {
      type: 'title',
      title: 'Шаг 2. Изучите референсы',
    },
    {
      type: 'list',
      items: [
        {
          tag: 'p',
          content: 'Опишите вслух или запишите из чего состоит предмет, какая у него форма.',
        },
        {
          tag: 'p',
          content: 'В какую простую фигуру его можно вписать? Квадрат, прямоугольник, овал?',
        },
        {
          tag: 'p',
          content: 'Какие части у него больше, какие меньше?',
        },
        {
          tag: 'p',
          content: 'Обратите внимание на контрформы — пустые пространства между деталями.',
        },
      ]
    },
    {
      type: 'text',
      text: 'Это поможет заранее продумать пропорции и избежать случайных ошибок.',
    },
    {
      type: 'title',
      title: 'Шаг 3. Рисуйте',
    },
    {
      ...
      items: [
        {
          tag: 'p',
          content: 'Нарисуйте 30 законченных рисунков на выбранную тему.',
        },
        {
          tag: 'p',
          content: 'Рисуйте сразу начисто, без стирания и исправлений.',
        },
        {
          tag: 'p',
          content: 'Начинайте от общего и двигайтесь к частному, чтобы сохранить цельность большой формы.',
        },
        {
          tag: 'p',
          content: 'Следите за пропорциями на листе, сравнивайте части между собой.',
        },
        {
          tag: 'p',
          content: 'Рисуйте до конца даже если кажется, что ошиблись.',
        },
      ]
    },
    {
    ...
    {
      type: 'text',
      text: 'Если хотите усложнить упражнение:',
    },
    {
      type: 'list',
      items: [
        {
          tag: 'p',
          content: 'Попробуйте показать объем линией.',
        },
        {
          tag: 'p',
          content: 'Используйте в одном рисунке две разные линии. Например, тонкую и толстую. Придерживайтесь правила 70/30 — одной линии должно быть явно больше, другой меньше.',
        },
      ]
    },
    {
