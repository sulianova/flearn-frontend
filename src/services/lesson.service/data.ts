  ...
  content: [
    {
      ...
      text: [
        {
          tag: 'p',
          content: 'В этом уроке вы познакомитесь с упражнениями, которые помогают чувствовать себя увереннее в рисовании. Их можно делать для разминки перед рисованием или целенаправленно тренировать то, что плохо получается.',
        },
        {
          tag: 'p',
          content: 'Для начала попробуйте каждое упражнение понемногу — чтобы понять, с чем оно может вам помочь. А потом возвращайтесь к тем, которые особенно нужны именно вам.',
        },
      ]
    },
    {
      type: 'title',
      title: 'Exercise #1: Прямые линии',
    },
        {
      type: 'image',
      imageData: {
    ...
    },
    {
      ...
      text: [
        {
          tag: 'span',
          content: 'Для чего нужно. ',
          props: { className: 'keyText' },
        },
        {
          tag: 'span',
          content: 'Развивает уверенность в движении руки, помогает научиться проводить ровные линии без дрожания и лишних пауз. Отлично подходит для разминки перед любой линейной работой или построением.',
        },
      ],
    },
    {
      type: 'title',
      title: 'Exercise #2: Параллельные линии',
    },
        {
      type: 'image',
      imageData: {
    ...
    },
    {
      ...
      text: [
        ...
        {
          tag: 'span',
          content: 'Учимся контролировать равные промежутки и направление линий. Полезно для построения сеток, перспективных линий, узоров и ровных штриховок.',
        },
      ],
    },
    {
      type: 'title',
      title: 'Exercise #3: Симметричные линии',
    },
        {
      type: 'image',
      imageData: {
    ...
    },
    {
      ...
      text: [
        ...
        {
          tag: 'span',
          content: 'Тренирует глазомер и навык зеркального повторения. Отлично помогает при рисовании симметричных объектов, орнаментов.',
        },
      ],
    },
    {
      type: 'title',
      title: 'Exercise #4: Непрерывные линии',
    },
        {
      type: 'image',
      imageData: {
    ...
    },
    {
      ...
      text: [
        ...
        {
          tag: 'span',
          content: 'Учимся мыслить формой и движением одновременно, вырабатываем уверенность и плавность линий. Помогает развить связность рисунка без лишних разрывов.',
        },
      ],
    },
    {
      type: 'title',
      title: 'Exercise #5: Разная толщина',
    },
        {
      type: 'image',
      imageData: {
    ...
    },
    {
      ...
      text: [
        ...
        {
          tag: 'span',
          content: 'Развивает чувство нажима и управление толщиной линии. Полезно для выразительных линий, леттеринга, живого контурного рисунка.',
        },
      ],
    },
    {
      type: 'title',
      title: 'Exercise #6: Раздели отрезок',
    },
        {
      type: 'image',
      imageData: {
    ...
    },
    {
      ...
      text: [
        ...
        {
          tag: 'span',
          content: 'Развивает глазомер, помогает научиться точно делить пространство и планировать композицию. Очень полезно для построений и сеток.',
        },
      ],
    },
    {
      type: 'title',
      title: 'Exercise #7: Повтори отрезок',
    },
        {
      type: 'image',
      imageData: {
    ...
    },
    {
      ...
      text: [
        ...
        {
          tag: 'span',
          content: 'Учимся запоминать и точно воспроизводить длину. Отлично помогает при построении ритма в композиции и модульных конструкций.',
        },
      ],
    },
       {
      type: 'title',
      title: 'Exercise #8: Пропорции',
    },
        {
      type: 'image',
      imageData: {
    ...
    },
    {
      ...
      text: [
        ...
        {
          tag: 'span',
          content: 'Развивает чувство пропорции и помогает быстро прикидывать нужное соотношение сторон при наброске или планировании композиций.',
        },
      ],
    },
    {
      type: 'title',
      title: 'Exercise #9: Круги и овалы за одно-два движения',
    },
    {
      type: 'image',
      imageData: {
        ...
        caption: [
          {
            tag: 'p',
            content: 'Круги и овалы за одно-два движения',
          },
        ],
      },
    },
    ...
    },
    {
      ...
      text: [
        ...
        {
          tag: 'span',
          content: 'Учимся проводить плавные, замкнутые линии. Полезно для любых округлых форм в рисунке — от фруктов до деталей механики и анатомии.',
        },
      ],
    },
       {
      type: 'title',
      title: 'Exercise #10: Силуэт и контрформа',
    },
        {
      type: 'image',
      imageData: {
    ...
    },
    {
      ...
      text: [
        ...
        {
          tag: 'span',
          content: 'Развивает понимание формы через положительное и отрицательное пространство. Помогает лучше видеть и воспроизводить силуэт и контрформу в композиции.',
        },
      ],
    },
        {
      type: 'title',
      title: 'Exercise #11: Светлое — тёмное',
    },
    {
      type: 'image',
      imageData: {
    ...
    },
    {
      ...
      text: [
        ...
        {
          tag: 'span',
          content: 'Тренирует контроль тона и плавные переходы. Помогает чувствовать светлоту и строить объем через светотень.',
        },
      ],
    },
        {
      type: 'title',
      title: 'Exercise #12: Сечения',
    },
    {
      type: 'image',
      imageData: {
    ...
    },
    {
      ...
      text: [
        ...
        {
          tag: 'span',
          content: 'Помогает понимать конструкцию и объем объекта. Учимся видеть форму не только снаружи, но и внутри, планируя, как она устроена.',
        },
      ],
    },
    {
