  ...
  content: [
    {
      ...
      text: [
        {
          tag: 'p',
          content: 'НВ этом уроке будем учиться рисовать похоже линией. Задача — отбирать из натуры только ту информацию, которая действительно нужна для понимания формы и характера предмета.',
        },
      ]
    },
    {
