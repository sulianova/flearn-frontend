  ...
  content: [
    ...
    // },
    {
      ...
      text: [
        {
          tag: 'p',
          content: 'Иллюстрация — это визуальный инструмент, который рассказывает истории, передаёт эмоции и помогает воспринимать информацию через образы. Она может быть выполнена в разных стилях и техниках: от реализма до абстракции, от цифрового рисования до акварели.',
        },
        {
          tag: 'p',
          content: 'Первый вопрос, который появляется в голове, когда мы садимся рисовать — про что будет картинка?',
        },
        {
          tag: 'p',
          content: 'Помимо сходства в рисунке всегда должно быть что-то еще. Одного сходства или узнавания недостаточно, чтобы рисунок состоялся. Важный вопрос, который стоит перед художником — “Про что картинка?” Нельзя просто сказать — я нарисовала похоже. Фотография все равно будет более похожа. Что мы можем сказать, что не может сказать фотография? ',
        },
      ]
    },
    {
    ...
    },
    {
      ...
      text: [
        {
          tag: 'p',
          content: 'Впечатление, которое мы получаем от иллюстрации складывается из двух вещей:',
        },
      ]
    },
    {
      ...
      items: [
        {
          tag: 'p',
          content: 'Идеи (литературного сюжета) — основного посыла, который она передаёт.',
        },
        {
          tag: 'p',
          content: 'Визуального языка (пластической идеи) — способа исполнения.',
        }
      ]
    },
    {
