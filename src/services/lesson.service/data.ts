...
const lessonData11: ILessonDataDB = {
  ...
  content: [
    ...
    {
      type: 'text',
      text: 'Вводный курс — это возможность прожить один день из жизни иллюстратора. Вы узнаете, как он рассуждает и какие задачи решает, а ещё — попробуете самостоятельно нарисовать иллюстрацию для статьи.'
    },
    {
      type: 'title',
      title: 'Платный курс'
  ...
  content: [
    ...
    },
    {
      ...
      text: [
        {
          tag: 'p',
          content: 'Вот дорога, по которой мы предлагаем отправиться дальше. Вы узнаете, какие задачи решает иллюстратор и как он помогает нам ориентироваться в этом мире. Потом на примере иллюстрации к статье освоите ключевые навыки, без которых иллюстратору никуда: работу с мудбордом, композицией и цветом. А затем сможете определиться, хотите ли продолжить обучение на платном курсе.'
        },
        {
          tag: 'p',
