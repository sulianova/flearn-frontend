...
const courseDB1: ICourseDataDB = {
  ...
  description: [
    ...
    {
      answer: 'На курсе будем учиться работать базовыми инструментами: линией, пятном и цветом. Разберемся, чем они отличаются, как их использовать. Сделаем упражнения, чтобы разрисоваться.',
  ...
  modules: [
    {
      content: [
        { tag: 'p', content: 'Сделаем 5-6 стикеров для телеграмма, в которых главный инструмент выразительности — линия.' },
        { tag: 'span', content: '• Упражнения, чтобы разрисоваться' },
        { tag: 'span', content: '• Линия: моторика, толщина, светлота' },
        { tag: 'span', content: '• Как рисовать объемно' },
    ...
    {
      content: [
        { tag: 'p', content: 'Сделаем 5-6 стикеров для телеграмма, в которых главный инструмент выразительности — пятно.' },
    ...
    {
      content: [
        { tag: 'p', content: 'Сделаем 5-6 стикеров для телеграмма, в которых главный инструмент выразительности — цвет.' },
...
const courseDB2: ICourseDataDB = {
  ...
  modules: [
    {
      content: [
        ...
        { tag: 'p', content: [
          ...
          { tag: 'span', props: { className: '' }, content: 'Консультация с преподавателем на 5-10 мин: ставим цели на интенсив.' },
          ]
        },
        { tag: 'p', content: [
          { tag: 'span',
          ...
          { tag: 'span', props: { className: '' }, content: 'Вебинар: "Генератор сюжетов". Разберемся, как придумывать острые, запоминающиеся сюжеты.' },
          ]
        },
        { tag: 'p', content: [
          { tag: 'span',
          ...
          { tag: 'span', props: { className: '' }, content: 'Вебинар: "Дневник наблюдений". Научимся анализировать работы других иллюстраторов и применять находки в своих рисунках.' },
          ]
        },
      ],
  ...
  faq: [
    {
      question: 'Как проходит онлайн обучение',
      answer: 'На интенсиве будет 1 большое задание и 3 вебинара в Пт, Сб и Вс в 20:00 по Мск. Вебинары — для общения, вся теория с первого дня будет доступна на сайте. Дедлайн загрузки задания — суббота, 23:59 по Мск. Вопросы, возникающие по ходу задаем в любое время в телеграмм-канале — раз в сутки преподаватель отвечает на них.'
    },
    {
      question: 'Какие материалы нужны',
    ...
    {
      question: 'Сколько длится доступ к материалам курса',
      answer: 'Если загрузить все задания, доступ к материалам останется навсегда. Если не сдать одно задание и больше — доступ на время курса + 1 неделя после. Всего 17 дней.'
    },
    {
      question: 'Как оплатить зарубежной картой',
      answer: 'Мы принимаем платежи в России и из-за рубежа. После записи на курс вам придет письмо на почту с инструкцией об оплате, и вы сможете выбрать удобный для вас способ.'
