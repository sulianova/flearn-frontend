...
const courseDB2: ICourseDataDB = {
  ...
  startDate: '2023.12.21 21:00:00 GMT',
  endDate: '2023.12.26 20:59:00 GMT',
  accessDeadline: '2023.12.26 20:59:00 GMT',
  duration: {
    unit: 'day',
    value: 5,
  },
  ...
  modules: [
    {
      content: [
        ...
        { tag: 'span', content: '•  Пластический сюжет: композиция, контрастность, формообразование, модульность, силуэт, контрформа, ритмы' },
        { tag: 'span', content: '•  Литературный сюжет: сюжет в один кадр, минимальный конфликт' },
      ],
