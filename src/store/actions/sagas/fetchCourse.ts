...
const courseDB2: ICourseDataDB = {
  ...
  endDate: '2024.01.07 20:59:00 GMT',
  ...
  modules: [
    {
      content: [
        ...
        { tag: 'p', content: [
          { tag: 'span',
          content: '1. Что такое иллюстрация, серия, стиль\nОдного сходства или узнавания недостаточно, чтобы рисунок состоялся. Важный вопрос, который стоит перед художником — “Про что картинка?” Нельзя просто сказать — я нарисовала похоже. Фотография все равно будет более похожа. Что мы можем сказать, что не может сказать фотография?'
          }
          ]
        },
        { tag: 'p', content: [
