...
const newCourseDB: ICourseDataDB = {
  ...
  modules: [
    {
      content: 'Познакомимся с упражнениями, которые помогают чувствовать себя увереннее в рисовании. Узнаем, что отвечает за узнавание и сходство. Разберемся, как показывать объем в линейном рисунке.',
      imageId: 'Block1.png',
      imageAlt: 'Block1',
