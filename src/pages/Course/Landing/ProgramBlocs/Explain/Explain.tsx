    ...
    <div className={classes.wrapper}>
      ...
      <div className={classes.cards}>
        ...
        <div className={classes.introCard}>
          <div className={classes['introCardQuote'] + ' s-text-36'}>“У меня не было академического образования, когда я начала рисовать. Я училась на курсах,  которые казались мне интересными, постепенно собирая свой личный набор инструментов.”</div>
        </div>
      </div>
    </div>
  );
