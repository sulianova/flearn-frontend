  ...
  return (
    <>
      <div className={classes.header}>
        <div className={classes.headerTitle + ' s-text-70'}>Много практики и обратной связи</div>
      </div>
        <div className={classes.points}>
        <div className={classes.pointsCard}>
          <h3 className={classes.pointsCardTitle + ' s-text-36'}>Поможем справиться со страхом ошибки</h3>
        ...
        <div className={classes.pointsCard}>
          <h3 className={classes.pointsCardTitle  + ' s-text-36'}>Направим и поддержим</h3>
        ...
        <div className={classes.pointsCard}>
          <h3 className={classes.pointsCardTitle + ' s-text-36'}>Доведем до результата</h3>
