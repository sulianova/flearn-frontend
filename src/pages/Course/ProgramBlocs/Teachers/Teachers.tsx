    ...
    <div className={classes.wrapper}>
      ...
      <div className={classes.section}>
        <div className={classes.card}>
          ...
          <div className={classes.cardDesc + ' s-text-24'}>Художник, автор курса. Закончила Британскую Высшую Школу Дизайна по курсу иллюстрация. Участвую в международных конкурсах для иллюстраторов. Рисую для себя и творческих проектов.</div>
        </div>
