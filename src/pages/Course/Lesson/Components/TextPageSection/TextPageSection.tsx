...
function TextPageSection() {
  return (
    ...
    //   <div className={classes.content}><a className="inline-link s-text-21"> Ссылка 1</a><a className="inline-link s-text-21"> Ссылка 2</a><a className="inline-link s-text-21"> Ссылка 3</a></div>
    // </section>
    // <section className={classes._}> 
