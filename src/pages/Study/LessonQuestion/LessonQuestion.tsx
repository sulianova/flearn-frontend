...
import classes from './LessonQuestion.module.scss';
    ...
    <div className={classes.question}>
      <div className={classes.wrapper}>
        <div className={classes.content}>
          ...
          {/* <div className={classes.title}>Хотим зафиксировать цель, с которой вы проходите вводную часть. А в конце спросим, получилось ли её достичь.</div>
          <div className={classes.subtitle}>Выберите цель:</div>
